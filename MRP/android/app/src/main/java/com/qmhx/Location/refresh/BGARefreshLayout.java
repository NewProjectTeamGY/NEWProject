...
package com.qmhx.Location.refresh;
...
public class BGARefreshLayout extends LinearLayout {
    ...
    public BGARefreshLayout(Context context, AttributeSet attrs) {
        ...
        /*final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.BGARefreshLayout);
        int refreshHeight = a.getDimensionPixelOffset(R.styleable.BGARefreshLayout_refresh_trigger_offset, 0);
        a.recycle();*/
        ...
        initWholeHeaderView();
        // 手动添加固定头部
        setRefreshViewHolder(new MyRefreshViewHolder(context, true));
    }
    ...
    /*public void setRefreshHeaderViewHeight(int height) {
        this.mRefreshHeaderViewHeight = -height;
    }*/
